<template>
  <div class="bg-surface-50 p-8 rounded-2xl border border-surface-200">
    <h4 class="text-xs font-bold text-surface-400 uppercase tracking-wider mb-6">Configuration</h4>
    ...
    <div v-else class="text-sm text-surface-500 italic flex items-center gap-2">
